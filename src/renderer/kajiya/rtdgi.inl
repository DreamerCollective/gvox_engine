...
DAXA_TH_IMAGE_INDEX(RAY_TRACING_SHADER_STORAGE_READ_WRITE, REGULAR_2D, candidate_irradiance_out_tex)
DAXA_TH_IMAGE_INDEX(RAY_TRACING_SHADER_STORAGE_READ_WRITE, REGULAR_2D, candidate_normal_out_tex)
DAXA_TH_IMAGE_INDEX(RAY_TRACING_SHADER_STORAGE_READ_WRITE, REGULAR_2D, candidate_hit_out_tex)
DAXA_TH_IMAGE_INDEX(RAY_TRACING_SHADER_SAMPLED, REGULAR_2D, rt_history_invalidity_in_tex)
DAXA_TH_IMAGE_INDEX(RAY_TRACING_SHADER_STORAGE_READ_WRITE, REGULAR_2D, rt_history_invalidity_out_tex)
DAXA_DECL_TASK_HEAD_END
